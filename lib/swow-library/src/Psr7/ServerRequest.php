...
class ServerRequest extends Request implements ServerRequestPlusInterface
{
    ...
    public static function createFromEntity(
        ...
        $serverRequest->uri = PsrHelper::createUriFromString($serverRequestEntity->uri, $uriFactory);
        ...
        if ($serverRequestEntity->body) {
            $serverRequest->body = PsrHelper::createStreamFromBuffer(
        ...
        if ($serverRequestEntity->uploadedFiles) {
            $serverRequest->uploadedFiles = PsrHelper::createUploadedFilesFromEntity(
