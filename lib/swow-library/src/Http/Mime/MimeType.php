...
class MimeType
{
    ...
    public const M2T = self::TS;
    public const M2TS = self::TS;
    ...
    public const ACE_TRL_CBOR = 'application/ace-trl+cbor';
    ...
    public const ALTO_TIPS_JSON = 'application/alto-tips+json';
    public const ALTO_TIPSPARAMS_JSON = 'application/alto-tipsparams+json';
    ...
    public const BUFR = 'application/bufr';
    public const C2PA = 'application/c2pa';
    ...
    public const CE_CBOR = 'application/ce+cbor';
    ...
    public const CID = 'application/cid';
    public const CID_EDHOC_CBOR_SEQ = 'application/cid-edhoc+cbor-seq';
    public const CITY_JSON = 'application/city+json';
    public const CITY_JSON_SEQ = 'application/city+json-seq';
    ...
    public const CWL_YAML = 'application/cwl+yaml';
    ...
    public const DPOP_JWT = 'application/dpop+jwt';
    ...
    public const EAT_CWT = 'application/eat+cwt';
    public const EAT_JWT = 'application/eat+jwt';
    public const EAT_BUN_CBOR = 'application/eat-bun+cbor';
    public const EAT_BUN_JSON = 'application/eat-bun+json';
    public const EAT_UCS_CBOR = 'application/eat-ucs+cbor';
    public const EAT_UCS_JSON = 'application/eat-ucs+json';
    public const ECMA = 'application/ecmascript';
    public const EDHOC_CBOR_SEQ = 'application/edhoc+cbor-seq';
    ...
    public const ENTITY_STATEMENT_JWT = 'application/entity-statement+jwt';
    ...
    public const GNAP_BINDING_JWS = 'application/gnap-binding-jws';
    public const GNAP_BINDING_JWSD = 'application/gnap-binding-jwsd';
    public const GNAP_BINDING_ROTATION_JWS = 'application/gnap-binding-rotation-jws';
    public const GNAP_BINDING_ROTATION_JWSD = 'application/gnap-binding-rotation-jwsd';
    public const GPX = 'application/gpx+xml';
    public const GRIB = 'application/grib';
    ...
    public const JSONPATH = 'application/jsonpath';
    ...
    public const OHTTP_KEYS = 'application/ohttp-keys';
    ...
    public const ONE = self::ONETOC;
    public const ONEA = self::ONETOC;
    ...
    public const PRIVATE_TOKEN_ISSUER_DIRECTORY = 'application/private-token-issuer-directory';
    public const PRIVATE_TOKEN_REQUEST = 'application/private-token-request';
    ...
    public const PRS_IMPLIED_DOCUMENT_XML = 'application/prs.implied-document+xml';
    public const PRS_IMPLIED_EXECUTABLE = 'application/prs.implied-executable';
    public const PRS_IMPLIED_OBJECT_JSON = 'application/prs.implied-object+json';
    public const PRS_IMPLIED_OBJECT_JSON_SEQ = 'application/prs.implied-object+json-seq';
    public const PRS_IMPLIED_OBJECT_YAML = 'application/prs.implied-object+yaml';
    public const PRS_IMPLIED_STRUCTURE = 'application/prs.implied-structure';
    public const PRS_MAYFILE = 'application/prs.mayfile';
    ...
    public const RESOLVE_RESPONSE_JWT = 'application/resolve-response+jwt';
    ...
    public const RPKI_SIGNED_TAL = 'application/rpki-signed-tal';
    public const RPKI_UPDOWN = 'application/rpki-updown';
    public const RS_METADATA_XML = 'application/rs-metadata+xml';
    ...
    public const SD_JWT = 'application/sd-jwt';
    public const SD_JWT_JSON = 'application/sd-jwt+json';
    public const SDF_JSON = 'application/sdf+json';
    ...
    public const SSLKEYLOGFILE = 'application/sslkeylogfile';
    public const SSML = 'application/ssml+xml';
    public const ST2110_41 = 'application/st2110-41';
    ...
    public const TEXINFO = 'application/texinfo';
    ...
    public const TOC_CBOR = 'application/toc+cbor';
    ...
    public const UCCS_CBOR = 'application/uccs+cbor';
    public const UJCS_JSON = 'application/ujcs+json';
    ...
    public const VND_1OB = 'application/vnd.1ob';
    ...
    public const VND_3GPP_5GSA2X = 'application/vnd.3gpp.5gsa2x';
    public const VND_3GPP_5GSA2X_LOCAL_SERVICE_INFORMATION = 'application/vnd.3gpp.5gsa2x-local-service-information';
    public const VND_3GPP_5GSV2X = 'application/vnd.3gpp.5gsv2x';
    public const VND_3GPP_5GSV2X_LOCAL_SERVICE_INFORMATION = 'application/vnd.3gpp.5gsv2x-local-service-information';
    ...
    public const VND_3GPP_CRS_XML = 'application/vnd.3gpp.crs+xml';
    public const VND_3GPP_CURRENT_LOCATION_DISCOVERY_XML = 'application/vnd.3gpp.current-location-discovery+xml';
    ...
    public const VND_3GPP_MCPTT_REGROUP_XML = 'application/vnd.3gpp.mcptt-regroup+xml';
    ...
    public const VND_3GPP_MCVIDEO_REGROUP_XML = 'application/vnd.3gpp.mcvideo-regroup+xml';
    ...
    public const VND_3GPP_PINAPP_INFO_XML = 'application/vnd.3gpp.pinapp-info+xml';
    ...
    public const VND_3GPP_SEAL_MBMS_USAGE_INFO_XML = 'application/vnd.3gpp.seal-mbms-usage-info+xml';
    public const VND_3GPP_SEAL_MBS_USAGE_INFO_XML = 'application/vnd.3gpp.seal-mbs-usage-info+xml';
    public const VND_3GPP_SEAL_NETWORK_QOS_MANAGEMENT_INFO_XML = 'application/vnd.3gpp.seal-network-qos-management-info+xml';
    public const VND_3GPP_SEAL_NETWORK_RESOURCE_INFO_CBOR = 'application/vnd.3gpp.seal-network-resource-info+cbor';
    public const VND_3GPP_SEAL_UE_CONFIG_INFO_XML = 'application/vnd.3gpp.seal-ue-config-info+xml';
    public const VND_3GPP_SEAL_UNICAST_INFO_XML = 'application/vnd.3gpp.seal-unicast-info+xml';
    public const VND_3GPP_SEAL_USER_PROFILE_INFO_XML = 'application/vnd.3gpp.seal-user-profile-info+xml';
    ...
    public const VND_3GPP_V2X = 'application/vnd.3gpp.v2x';
    ...
    public const VND_ACM_ADDRESSXFER_JSON = 'application/vnd.acm.addressxfer+json';
    public const VND_ACM_CHATBOT_JSON = 'application/vnd.acm.chatbot+json';
    ...
    public const VND_BZIP3 = 'application/vnd.bzip3';
    public const VND_C3VOC_SCHEDULE_XML = 'application/vnd.c3voc.schedule+xml';
    ...
    public const VND_CEL = 'application/vnd.cel';
    ...
    public const VND_CNCF_HELM_CONFIG_V1_JSON = 'application/vnd.cncf.helm.config.v1+json';
    ...
    public const DCMP = 'application/vnd.dcmp+xml';
    ...
    public const VND_EROFS = 'application/vnd.erofs';
    ...
    public const VND_FREELOG_COMIC = 'application/vnd.freelog.comic';
    ...
    public const VND_GEOGEBRA_PINBOARD = 'application/vnd.geogebra.pinboard';
    public const GGS = 'application/vnd.geogebra.slides';
    ...
    public const VND_GOOGLE_APPS_AUDIO = 'application/vnd.google-apps.audio';
    public const GDOC = 'application/vnd.google-apps.document';
    public const GDRAW = 'application/vnd.google-apps.drawing';
    public const VND_GOOGLE_APPS_DRIVE_SDK = 'application/vnd.google-apps.drive-sdk';
    public const VND_GOOGLE_APPS_FILE = 'application/vnd.google-apps.file';
    public const VND_GOOGLE_APPS_FOLDER = 'application/vnd.google-apps.folder';
    public const GFORM = 'application/vnd.google-apps.form';
    public const VND_GOOGLE_APPS_FUSIONTABLE = 'application/vnd.google-apps.fusiontable';
    public const GJAM = 'application/vnd.google-apps.jam';
    public const VND_GOOGLE_APPS_MAIL_LAYOUT = 'application/vnd.google-apps.mail-layout';
    public const GMAP = 'application/vnd.google-apps.map';
    public const VND_GOOGLE_APPS_PHOTO = 'application/vnd.google-apps.photo';
    public const GSLIDES = 'application/vnd.google-apps.presentation';
    public const GSCRIPT = 'application/vnd.google-apps.script';
    public const VND_GOOGLE_APPS_SHORTCUT = 'application/vnd.google-apps.shortcut';
    public const GSITE = 'application/vnd.google-apps.site';
    public const GSHEET = 'application/vnd.google-apps.spreadsheet';
    public const VND_GOOGLE_APPS_UNKNOWN = 'application/vnd.google-apps.unknown';
    public const VND_GOOGLE_APPS_VIDEO = 'application/vnd.google-apps.video';
    ...
    public const XDCF = 'application/vnd.gov.sk.xmldatacontainer+xml';
    ...
    public const VND_IPFS_IPNS_RECORD = 'application/vnd.ipfs.ipns-record';
    ...
    public const VND_KDL = 'application/vnd.kdl';
    public const HTKE = 'application/vnd.kenameaapp';
    public const VND_KEYMAN_KMP_ZIP = 'application/vnd.keyman.kmp+zip';
    public const VND_KEYMAN_KMX = 'application/vnd.keyman.kmx';
    ...
    public const VND_LDEV_PRODUCTLICENSING = 'application/vnd.ldev.productlicensing';
    ...
    public const VND_MDL = 'application/vnd.mdl';
    public const VND_MDL_MBSDF = 'application/vnd.mdl-mbsdf';
    ...
    public const VND_MERMAID = 'application/vnd.mermaid';
    ...
    public const VND_MODL = 'application/vnd.modl';
    ...
    public const VND_MSGPACK = 'application/vnd.msgpack';
    ...
    public const VND_NATO_BINDINGDATAOBJECT_CBOR = 'application/vnd.nato.bindingdataobject+cbor';
    public const VND_NATO_BINDINGDATAOBJECT_JSON = 'application/vnd.nato.bindingdataobject+json';
    public const BDO = 'application/vnd.nato.bindingdataobject+xml';
    public const VND_NATO_OPENXMLFORMATS_PACKAGE_IEPD_ZIP = 'application/vnd.nato.openxmlformats-package.iepd+zip';
    ...
    public const VND_OASIS_OPENDOCUMENT_TEXT_MASTER_TEMPLATE = 'application/vnd.oasis.opendocument.text-master-template';
    ...
    public const VND_PMTILES = 'application/vnd.pmtiles';
    ...
    public const VND_RELPIPE = 'application/vnd.relpipe';
    ...
    public const VND_SUPERFILE_SUPER = 'application/vnd.superfile.super';
    ...
    public const VSDX = self::VSD;
    public const VTX = self::VSD;
    ...
    public const VOUCHER_JWS_JSON = 'application/voucher-jws+json';
    ...
    public const BLEND = 'application/x-blender';
    ...
    public const IPYNB = 'application/x-ipynb+json';
    ...
    public const YANG_SID_JSON = 'application/yang-sid+json';
    public const YIN = 'application/yin+xml';
    public const LOTTIE = 'application/zip+dotlottie';
    ...
    public const MIDI_CLIP = 'audio/midi-clip';
    public const MXMF = 'audio/mobile-xmf';
    public const MP4A = 'audio/mp4';
    public const M4B = self::MP4A;
    ...
    public const VND_BLOCKFACT_FACTA = 'audio/vnd.blockfact.facta';
    ...
    public const J2C = 'image/j2c';
    public const JAII = 'image/jaii';
    public const JAIS = 'image/jais';
    ...
    public const FACTI = 'image/vnd.blockfact.facti';
    public const VND_CLIP = 'image/vnd.clip';
    ...
    public const MLS = 'message/mls';
    public const NEWS = 'message/news';
    public const OHTTP_REQ = 'message/ohttp-req';
    public const OHTTP_RES = 'message/ohttp-res';
    public const PARTIAL = 'message/partial';
    public const EML = 'message/rfc822';
    public const MIME = self::EML;
    public const MHT = self::EML;
    public const MHTML = self::EML;
    ...
    public const BARY = 'model/vnd.bary';
    ...
    public const PRS_TEXI = 'text/prs.texi';
    ...
    public const VND_BLOCKFACT_FACTV = 'video/vnd.blockfact.factv';
    ...
    public const VND_PLANAR = 'video/vnd.planar';
