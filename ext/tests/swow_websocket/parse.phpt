...
Assert::same($frame->getFin(), true);
Assert::same($frame->getRSV1(), false);
Assert::same($frame->getRSV2(), false);
Assert::same($frame->getRSV3(), false);
...
Assert::same($frame->getFin(), true);
Assert::same($frame->getRSV1(), true);
Assert::same($frame->getRSV2(), false);
Assert::same($frame->getRSV3(), false);
Assert::same($frame->getOpcode(), 1);
...
Assert::same($frame->getFin(), false);
Assert::same($frame->getRSV1(), false);
Assert::same($frame->getRSV2(), true);
Assert::same($frame->getRSV3(), false);
...
Assert::same($frame->getRSV1(), false);
Assert::same($frame->getRSV2(), false);
Assert::same($frame->getRSV3(), true);
Assert::same($frame->getOpcode(), 2);
Assert::same($frame->getMask(), true);
