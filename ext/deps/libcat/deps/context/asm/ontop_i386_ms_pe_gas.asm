...
.globl	_cat_coroutine_context_ontop
.def	_cat_coroutine_context_ontop;	.scl	2;	.type	32;	.endef
_cat_coroutine_context_ontop:
    /* prepare stack */
    leal  -0x2c(%esp), %esp

#if !defined(CAT_USE_TSX)
    ...
    /* first arg of cat_coroutine_context_ontop() == fcontext to jump to */
    movl  0x30(%esp), %eax

	/* pass parent fcontext_t */
	movl  %ecx, 0x30(%eax)

    /* second arg of cat_coroutine_context_ontop() == data to be transferred */
    movl  0x34(%esp), %ecx

	/* pass data */
	movl  %ecx, 0x34(%eax)

    /* third arg of cat_coroutine_context_ontop() == ontop-function */
    movl  0x38(%esp), %ecx
...
.section .drectve
.ascii " -export:\"cat_coroutine_context_ontop\""
