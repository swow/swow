...
.globl	_cat_coroutine_context_jump
.def	_cat_coroutine_context_jump;	.scl	2;	.type	32;	.endef
_cat_coroutine_context_jump:
    /* prepare stack */
    leal  -0x2c(%esp), %esp
...
.section .drectve
.ascii " -export:\"cat_coroutine_context_jump\""
